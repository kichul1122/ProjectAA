...
namespace AA
{
   ...
   {
        public CharacterMetaDataTable CharacterMetaDataTable { get; private set; }

        public MemoryDatabase(
            CharacterMetaDataTable CharacterMetaDataTable
        )
        {
            this.CharacterMetaDataTable = CharacterMetaDataTable;
        }
        ...
        {
            this.CharacterMetaDataTable = ExtractTableData<CharacterMetaData, CharacterMetaDataTable>(header, databaseBinary, options, xs => new CharacterMetaDataTable(xs));
        }
        ...
        public DatabaseBuilder ToDatabaseBuilder()
        {
            ...
            builder.Append(this.CharacterMetaDataTable.GetRawDataUnsafe());
            return builder;
        }
        ...
        public ValidateResult Validate()
        {
            ...
            {
                CharacterMetaDataTable,
            });

            ((ITableUniqueValidate)CharacterMetaDataTable).ValidateUnique(result);
            ValidateTable(CharacterMetaDataTable.All, database, "CharacterId", CharacterMetaDataTable.PrimaryKeySelector, result);
        ...
        public static object GetTable(MemoryDatabase db, string tableName)
        {
            ...
            {
                case "character":
                    return db.CharacterMetaDataTable;
        ...
        public static MasterMemory.Meta.MetaDatabase GetMetaDatabase()
        {
            ...
            dict.Add("character", AA.Tables.CharacterMetaDataTable.CreateMetaTable());
